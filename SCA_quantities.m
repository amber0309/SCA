function [P, T, D, Q, K_bar] = SCA_quantities(K, X, Y)
%{
compute quantities required by scatter component analysis [1]

INPUT
    K      - kernel matrix of data of all source domains
    X      - cell, each element (N by dim) corresponds to the data of a domain
    Y      - cell, each element (N by 1) corresponds to the label of a domain
